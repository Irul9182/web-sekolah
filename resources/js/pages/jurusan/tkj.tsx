    ...
    return (
        <PublicLayout>
            <section className="mx-auto max-w-4xl px-4 py-16 pt-32">
                <SectionHeader title="Teknik Komputer & Jaringan (TKJ)" />
                ...
                <div className="space-y-4 rounded-lg border p-6" style={{ borderColor: 'var(--border)', backgroundColor: 'var(--card)' }}>
                    <p className="leading-relaxed" style={{ color: 'var(--card-foreground)' }}>
                        [Placeholder] Jurusan TKJ mempelajari instalasi jaringan komputer, troubleshooting hardware, dan administrasi sistem.
                        Lulusan siap bekerja sebagai teknisi jaringan dan IT support. Ganti teks ini dengan deskripsi resmi jurusan.
                    </p>
                    <div>
                        ...
                        <ul className="list-disc space-y-1 pl-5" style={{ color: 'var(--card-foreground)' }}>
                            <li>[Placeholder] Instalasi dan konfigurasi jaringan</li>
                            <li>[Placeholder] Perawatan dan perbaikan perangkat keras</li>
                            <li>[Placeholder] Administrasi server</li>
                        </ul>
                    </div>
                </div>
            </section>
