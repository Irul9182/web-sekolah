...
// import { BeritaProps, BeritaPropsForm, GaleriOption, initialBeritaValue } from '@/types/berita.type';
...
//                                         className={cn(
//                                             'group hover:bg-muted! flex cursor-pointer items-center justify-between rounded-sm p-2 transition-all',
//                                         )}
//                                     >
...
//                                 <div>
//                                     <label className="mb-1 block text-sm text-gray-600">Galeri Terkait (opsional)</label>
//                                     <select
//                                         value={data.galeri_id ?? ''}
//                                         onChange={(e) => setData('galeri_id', e.target.value || null)}
//                                         className="w-full rounded-lg border border-gray-300 p-3 focus:ring-2 focus:ring-indigo-500 focus:outline-none"
//                                     >
//                                         <option value="">— Tidak ada —</option>
//                                         {galeris.map((galeri) => (
//                                             <option key={galeri.id} value={galeri.id}>
//                                                 {galeri.judul}
//                                                 {galeri.bulan && galeri.tahun ? ` (${galeri.bulan} ${galeri.tahun})` : ''}
//                                             </option>
//                                         ))}
//                                     </select>
//                                     <p className="mt-1 text-xs text-gray-400">
//                                         Hubungkan berita ini ke album galeri agar pembaca bisa melihat foto tambahan terkait acara ini.
//                                     </p>
//                                     {errors.galeri_id && <p className="mt-1 text-sm text-red-500">{errors.galeri_id}</p>}
//                                 </div>
...
//                                 {selectedData?.galeri && (
//                                     <div className="mt-3">
//                                         <p className="mb-2 font-semibold">Galeri Terkait :</p>
//                                         <a
//                                             href={route('public.galeri.show', selectedData.galeri.slug)}
//                                             target="_blank"
//                                             rel="noopener noreferrer"
//                                             className="bg-background/50 hover:bg-muted flex max-w-70 items-center gap-2 rounded-md border p-3 text-sm transition sm:max-w-100"
//                                         >
//                                             <ImageIcon className="text-muted-foreground h-4 w-4 shrink-0" />
//                                             <span className="truncate">{selectedData.galeri.judul}</span>
//                                         </a>
//                                     </div>
//                                 )}
//                             </ModalBody>
