<html>
    ...
    <body>
        ...
        <script>
            ...
            const toDaftar = document.getElementById("toDaftar");
            const toLogin = document.getElementById("toLogin");

            const formLogin = document.querySelector(".form_login");
            const formDaftar = document.querySelector(".form_daftar");

            // pindah ke daftar
            toDaftar.onclick = function(){
            ...
            const tombolLogin = document.querySelector(".tombol_login");
            ...
            masuk.onclick = function(){
                if(username.value == "admin" && password.value == "123"){
                    ...
                    tombolLogout.classList.add("active");
                }
