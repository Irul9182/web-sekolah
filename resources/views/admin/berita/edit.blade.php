...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .gambar-preview { width: 200px; border-radius: 8px; margin-bottom: 10px; }
    </style>
</head>
<body>
    ...
    <div class="form-box">
        ...
        <form method="POST" action="/admin/berita/{{ $berita->id }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea name="isi">{{ old('isi', $berita->isi) }}</textarea>
            ...
            <div class="form-group">
                <label>Gambar</label>
                @if($berita->gambar)
                    <img src="{{ asset('storage/'.$berita->gambar) }}" class="gambar-preview"><br>
                    <small style="color:#888">Upload gambar baru untuk mengganti</small><br><br>
                @endif
